        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h2 class="text-2xl font-bold mb-6">Fuvarozó Dashboard</h2>
                    ...
                    <div class="mb-6 p-4 bg-blue-50 rounded-lg">
                        <p class="font-medium">Üdv, {{ Auth::user()->name }}!</p>
                        <p class="text-sm text-gray-600">Email: {{ Auth::user()->email }}</p>
                    </div>

                    <h3 class="text-xl font-bold mb-4">Az én munkáim</h3>

                    @forelse($munkak as $munka)
                        <div class="bg-gray-50 rounded-lg p-4 mb-4 border border-gray-200">
                            <div class="flex justify-between items-start mb-3">
                                <div>
                                    <h4 class="font-bold text-lg">Munka #{{ $munka->id }}</h4>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    <h5 class="font-medium text-gray-700 mb-1">Útvonal</h5>
                                    <div class="text-sm">
                                ...
                                <div>
                                    <h5 class="font-medium text-gray-700 mb-1">Címzett</h5>
                                    <div class="text-sm">
